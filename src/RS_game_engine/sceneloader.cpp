...
bool SceneLoader::sceneSave(GameBuilder* scene){
    ...
    Bground["path"] = getBackgroundName();
    qDebug() << "Iz ScreenLoadera" + getBackgroundName();
    parentJson.push_back(Bground);
    ...
    QString fileName = QFileDialog::getSaveFileName(nullptr, "Save file","../../") + ".json";
...
QString SceneLoader::getBackgroundName() const
{
    return BackgroundName;
}

void SceneLoader::setBackgroundName(const QString &value)
{
